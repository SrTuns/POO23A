...
namespace POO23A_MA
{
    internal class CZombieWitch : CZombie
    {
        public CZombieWitch(Control AreaDesplazamiento) : base(AreaDesplazamiento)
        {
            int X;
            int Y;
        ...
        {
            return new Bitmap(Resources.Witch);
        }

        protected override SoundPlayer SonidoRugido()
        {
            return new SoundPlayer(Resources.SonidoWitchEnojada);
        }

        protected override SoundPlayer SonidoMorir()
        {
            return new SoundPlayer(Resources.SonidoWitchrMuerte);
        }
